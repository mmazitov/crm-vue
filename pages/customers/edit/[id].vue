	...
	<div class="p-10">
		...
		<form @submit="onSubmit" class="form">
			...
			<img
				...
				width="50"
				height="50"
				class="my-4 rounded-full"
			/>
			<div class="items-center gap-1.5 grid w-full max-w-sm input">
				<label>
					<div class="mb-2 text-sm">Logo</div>
					<UiInput
						type="file"
...
<style scoped>
.input {
	@apply mb-4 border-[#161c26] focus:border-border placeholder:text-[#748092] transition-colors;
}
</style>
